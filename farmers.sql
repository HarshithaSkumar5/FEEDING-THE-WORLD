...
('harsh', 'harsh@gmail.com', 1, 'TOMATO', '  Well drained medium loam and or sandy loam soils are suitable.', 120),
('Ram', 'ram@gmail.com', 2, 'COTTON', 'Cotton is a soft, fluffy staple fiber that grows in a boll,around the seeds of the cotton ', 163),
('Seeta', 'seeta@gmail.com', 3, 'silk', 'silk is best business developed from coocon for saries preparation and so on', 182);
...
(5, 'Likitha', '876534289087','22','Female','9087653427','Bangalore','Silk' );
...
(5, 'Seeta', 'seeta@gmail.com', 'pbkdf2:sha256:150000$TfhDWqOr$d4cf40cc6cbfccbdcd1410f9e155ef2aa660620b0439a60c4d74085dbf007a4a');
